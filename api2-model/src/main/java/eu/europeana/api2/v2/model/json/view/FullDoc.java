...
//	boolean isOptedOut = false;
    ...
    public FullDoc(FullBean bean) {
        ...
        if (bean.getType() != null) type = bean.getType().toString();
...
//		}
    ...
    public void setEnrichmentPeriodBroaderLabel(String[] enrichmentPeriodBroaderLabel) {
    ...
    public void setEnrichmentConceptBroaderTerm(String[] enrichmentConceptBroaderTerm) {
    ...
    public void setEnrichmentConceptBroaderLabel(String[] enrichmentConceptBroaderLabel) {
